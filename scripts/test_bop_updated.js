...
CRITICAL EXCEPTION: Do NOT return empty arrays if you see actual part names accompanied by alphanumeric codes (e.g., 'EXAMPLE_PART_NAME_DO_NOT_COPY', 'a. Part Name', etc.), even if the text contains chapter numbers like '99.99'. If specific parts exist, you MUST extract them regardless of the surrounding layout.
  ...
  "maintenance": [
    {
      ...
      "maintenance_routine": "Daily / Shift",
      "checks_instructions": "Inspect hydraulic cylinder for oil leaks."
    }
  ],
  "spare_parts": [
    {
      "equipment_title": "EXAMPLE_EQUIPMENT_DO_NOT_COPY",
      "subsystem_location": "Brake Assembly",
      "item_no": "12",
      "part_name": "Sealing Ring",
      "part_number_code": "GB/T3452.1",
      "drawing_model_no": "JC70-02",
      "oem_standard_body": "OEM",
      "part_categorization": "Consumable",
      "quantity": "2",
      "recommended_stock_qty": "4",
      "warranty_period": "NA",
      "frequency_of_use": "Replace during overhaul / Medium"
    }
  ]
}
...
"""`;
  ...
  console.log("Raw JSON:", JSON.stringify(resultJson, null, 2));
}
