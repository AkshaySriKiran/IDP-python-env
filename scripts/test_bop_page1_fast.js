...
"""`;
  ...
  try {
     const j = JSON.parse(cleanResponse);
     console.log("JSON Parse Success!", j.spare_parts.length, "parts extracted");
     if(j.spare_parts.length > 0) {
        console.log("First part keys:", Object.keys(j.spare_parts[0]));
     }
  } catch(e) {
